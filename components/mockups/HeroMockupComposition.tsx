...
export default function HeroMockupComposition() {
  return (
    <div className="relative w-full">
      ...
      >
        {/* Phone glow */}
        <div className="absolute -inset-4 rounded-3xl bg-[#22B07D]/[0.06] blur-[30px]" />
      ...
      <div className="absolute bottom-8 left-20 z-15 hidden h-px w-16 bg-gradient-to-r from-[#22B07D]/30 to-transparent sm:block" />
    </div>
  );
}
